...
import org.dragonegg.ofuton.adapter.TwitterListAdapter;
import org.dragonegg.ofuton.fragment.FollowersOfUserFragment;
import org.dragonegg.ofuton.fragment.FriendsOfUserFragment;
import org.dragonegg.ofuton.fragment.adapter.UserFragmentPagerAdapter;
import org.dragonegg.ofuton.fragment.dialog.ListSelectDialogFragment;
import org.dragonegg.ofuton.fragment.timeline.FavoriteTimelineFragment;
import org.dragonegg.ofuton.fragment.timeline.UserTimelineFragment;
import org.dragonegg.ofuton.util.AppUtil;
import org.dragonegg.ofuton.util.ParallelTask;
import org.dragonegg.ofuton.util.ProgressDialogFragment;
import org.dragonegg.ofuton.util.TwitterList;
...
import org.dragonegg.ofuton.widget.TapToScrollTopListener;
            ...
            protected void onPostExecute(List<UserList> lists) {
                ...
                if (lists != null) {
                    ...
                    for (UserList list : lists) {
                        TwitterList tList = new TwitterList(userId, list.getId(), list.getName(), list.getFullName(), list.getUser().getScreenName(), (list.getUser().getId() == userId));
